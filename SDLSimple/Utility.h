...
public:
    ...
    static GLuint get_font_id() {return g_font_texture_id;}
//    static void lives_helper(int lives) {lives--;}
//    static void lives_update() { lives_helper(); }
    static void initialize();
private:
    static GLuint g_font_texture_id;
